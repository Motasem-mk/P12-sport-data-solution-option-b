...
Metabase is used as a PowerBI-equivalent BI tool.

The dashboard reads from the PostgreSQL OLAP layer produced by the Gold processing job.

Main dashboard indicators include:

* total number of employees;
* number of sportive employees;
* eligible employees for commute bonus;
* estimated financial impact;
* wellbeing day eligibility;
* activity volume;
* activity trends over time;
* activity distribution by sport type;
* data quality indicators.

Metabase was selected because it is easy to run locally with Docker and can connect directly to PostgreSQL.

Dashboard screenshots and query documentation are stored in:
